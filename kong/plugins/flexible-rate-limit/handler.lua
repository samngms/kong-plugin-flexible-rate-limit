  ...
  for i, cfg in ipairs(cfgList) do
    ...
    if type(count) ~= "number" then
      ...
      elseif count > cfg.limit then
        ...
        rd:set_keepalive()
        return kong.response.exit(cfg.err_code or err_code, cfg.err_msg or err_msg)
      end
    end
  end
  -- https://openresty-reference.readthedocs.io/en/latest/Lua_Nginx_API/#tcpsocksetkeepalive
  -- keepalive means return to connection pool
  rd:set_keepalive()
